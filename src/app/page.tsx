        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <a href="#" className="text-2xl font-bold font-title">
              <span className="text-white">RE\</span><span className="text-gray-400">/E</span>
            </a>
  ...
  --kb`,
      ...
      <footer className="py-8 border-t border-white/10">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="font-title text-lg"><span className="text-white">RE\</span><span className="text-gray-400">/E</span></span>
          <a
            href="https://github.com/Kunull/REeve"
            target="_blank"
            rel="noopener noreferrer"
